      ...
      try {
        (async () => {
          ...
          setSchedule((prevState) => ({ 
            ...
            body: (currentBody && currentBody.trim()) ? currentBody : (data.body || '')
          }));
                        ...
                        <FormControl variant="outlined" fullWidth margin="dense">
                          ...
                          <Select
                            ...
                            onChange={(e) => {
                              ...
                              setSchedule({ ...schedule, sendType: e.target.value });
                            }}
                            label="Tipo de Envio"
                          >
                            ...
                            <FormControl variant="outlined" fullWidth>
                              <Autocomplete
                                ...
                                onChange={(e, newValue) => {
                                  ...
                                  setSchedule({ ...schedule, contactIds: newValue.map(c => c.id) });
                                }}
                                getOptionLabel={(option) => option.name}
                                renderOption={renderOption}
                                getOptionSelected={(option, value) => value.id === option.id}
                            ...
                            <FormControl variant="outlined" fullWidth>
                              <Autocomplete
                                ...
                                onChange={(e, newValue) => {
                                  ...
                                  setSchedule({ ...schedule, tagIds: newValue.map(t => t.id) });
                                }}
